...
import { ArrowLeft, Heart, Star, MapPin, Clock, Calendar, ChevronRight } from 'lucide-react-native';
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.headerActions}>
            ...
            <TouchableOpacity style={styles.actionButton} onPress={handleFavoriteToggle}>
              <Heart size={24} color="white" fill={isFavorite ? 'white' : 'transparent'} />
            </TouchableOpacity>
          </View>
        </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.availabilityContainer}>
              <View style={styles.availabilityItem}>
                ...
                <Text style={styles.availabilityText}>Available hours: {service.availability.hours}</Text>
              </View>
              
              <View style={styles.availabilityItem}>
                <Calendar size={20} color={COLORS.accent} />
                <Text style={styles.availabilityText}>Available days: {service.availability.days}</Text>
              </View>
            </View>
          </View>
                ...
                <View style={styles.starsContainer}>
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star
                      ...
                      size={16}
                      color="#FFB800"
                      fill={star <= Math.floor(service.rating) ? "#FFB800" : "transparent"}
                    />
                  ))}
                </View>
              ...
              <View style={styles.ratingBreakdownItems}>
                <View style={styles.ratingBreakdownItem}>
                  ...
                  <View style={styles.ratingBar}>
                    <View style={[styles.ratingFill, { width: `${(service.ratings.respect / 5) * 100}%` }]} />
                  </View>
                  <Text style={styles.ratingValueText}>{service.ratings.respect}</Text>
                </View>
                
                <View style={styles.ratingBreakdownItem}>
                  <Text style={styles.ratingCategoryText}>Trust</Text>
                  <View style={styles.ratingBar}>
                    <View style={[styles.ratingFill, { width: `${(service.ratings.trust / 5) * 100}%` }]} />
                  </View>
                  <Text style={styles.ratingValueText}>{service.ratings.trust}</Text>
                </View>
                
                <View style={styles.ratingBreakdownItem}>
                  <Text style={styles.ratingCategoryText}>Communication</Text>
                  <View style={styles.ratingBar}>
                    <View style={[styles.ratingFill, { width: `${(service.ratings.communication / 5) * 100}%` }]} />
                  </View>
                  <Text style={styles.ratingValueText}>{service.ratings.communication}</Text>
                </View>
                
                <View style={styles.ratingBreakdownItem}>
                  <Text style={styles.ratingCategoryText}>Punctuality</Text>
                  <View style={styles.ratingBar}>
                    <View style={[styles.ratingFill, { width: `${(service.ratings.punctuality / 5) * 100}%` }]} />
                  </View>
                  <Text style={styles.ratingValueText}>{service.ratings.punctuality}</Text>
                </View>
              </View>
            </View>
